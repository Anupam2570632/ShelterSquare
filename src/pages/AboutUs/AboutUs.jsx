        ...
        <div className="bg-cover bg-fixed bg-center" style={{
            ...
            <div className="hero min-h-screen bg-base-200">
                <div className="hero-content flex-col lg:flex-row">
                    <img src="http://androthemes.com/themes/react/acres/assets/img/listings-list/3.jpg" className="max-w-lg w-full rounded-lg object-cover object-center shadow-2xl" />
                    <div className="ml-8">
                        <p className="text-blue-700 mb-4 text-xl font-semibold">About Us</p>
                        <h1 className="text-5xl font-bold">We provide state of the art real estate service</h1>
                        <p className="py-6 text-[#333333]">Explore our meticulously curated selection of premier real estate properties. From urban lofts to countryside estates, we offer top-tier listings tailored to your needs.</p>
                        <div>
                            <Link to={'/'}>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                        <div className="space-y-4">
                            ...
                            <div className="flex gap-4 items-center ">
                                <img className="w-20 rounded-xl" src="http://androthemes.com/themes/react/acres/assets/img/people/1.jpg" alt="" />
                                <div>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex gap-4 items-center ">
                                <img className="w-20 rounded-xl" src="http://androthemes.com/themes/react/acres/assets/img/people/2.jpg" alt="" />
                                <div>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex gap-4 items-center ">
                                <img className="w-20 rounded-xl" src="http://androthemes.com/themes/react/acres/assets/img/people/3.jpg" alt="" />
                                <div>
